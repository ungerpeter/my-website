  ...
  return (
    <div class={center({ perspective: "1000px" })}>
      ...
      >
        <div id="head">
          <svg viewBox={viewBox}>
            <g id="head_g" transform="translate(-38.562516,-23.609584)">
              <path
        ...
        <div id="eyes">
          <svg ref={eyesSvgRef} viewBox={viewBox}>
            ...
            <g id="eyes_g" transform="translate(-38.562516,-23.609584)">
              <path
                d="m 126.0569,114.15587 c 1.46028,-2.70064 2.80204,-3.13415 4.33238,-4.1236 2.04901,-1.3248 4.34287,-2.3825 6.73348,-2.87086 2.19907,-0.44923 4.21484,7.5e-4 6.42029,0.41758 2.29539,0.43383 4.52612,1.34824 6.52469,2.55768 1.04465,0.63217 2.78914,1.81057 2.76646,2.40108 -0.0323,0.84027 -1.84427,1.78234 -3.28844,2.55767 -2.02106,1.08506 -3.72042,1.66324 -5.58513,2.2445 -1.96633,0.61294 -4.05598,1.12681 -6.1071,0.93955 -1.68777,-0.15409 -3.19786,-1.12395 -4.80217,-1.67032 -1.45834,-0.49665 -2.97373,-0.84276 -4.38459,-1.46152 -0.75568,-0.33142 -1.7836,-0.0694 -2.29669,0 -0.34354,0.0465 -0.47807,-0.68681 -0.31318,-0.99176 z"
                id="right_eye"
              />
        ...
        <div id="lips">
          <svg viewBox={viewBox}>
            <g id="lips_g" transform="translate(-38.562516,-23.609584)">
              <path
        ...
        <div id="goat_beard">
          <svg viewBox={viewBox}>
            <g id="goat_beard_g" transform="translate(-38.562516,-23.609584)">
        ...
        <div id="chin_beard">
          <svg viewBox={viewBox}>
            <g id="chin_beard_g" transform="translate(-38.562516,-23.609584)">
        ...
        <div id="mustache_beard">
          <svg viewBox={viewBox}>
            <g
              id="mustache_beard_g"
              transform="translate(-38.562516,-23.609584)"
            >
        ...
        <div id="ears">
          <svg viewBox={viewBox}>
            <g id="ears_g" transform="translate(-38.562516,-23.609584)">
              <path
        ...
        <div id="eye_accents">
          <svg viewBox={viewBox}>
            <g id="eye_accents_g" transform="translate(-38.562516,-23.609584)">
              <path
        ...
        <div id="eyebrows">
          <svg viewBox={viewBox}>
            <g id="eyebrows_g" transform="translate(-38.562516,-23.609584)">
              <path
        ...
        <div id="head_accents">
          <svg viewBox={viewBox}>
            <g id="head_accents_g" transform="translate(-38.562516,-23.609584)">
              <path
        ...
        <div id="nose">
          <svg viewBox={viewBox}>
            <g id="nose_g" transform="translate(-38.562516,-23.609584)">
              <path
        ...
        <div id="glasses">
          <svg viewBox={viewBox}>
            <g id="glasses_g" transform="translate(-38.562516,-23.609584)">
              <path
