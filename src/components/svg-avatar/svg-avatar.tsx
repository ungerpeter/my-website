  ...
  return (
    <div class={center({ perspective: "1000px", flexDir: "column" })}>
      ...
      >
        ...
        <div
          id="pupils"
          style={{ transform: `translateZ(${zLayers.pupils}px)` }}
        >
          <svg viewBox={viewBox}>
            <defs>
        ...
        <div
          id="goat_beard"
          style={{ transform: `translateZ(${zLayers.goat_beard}px)` }}
        >
          <svg viewBox={viewBox}>
        ...
        <div
          id="chin_beard"
          style={{ transform: `translateZ(${zLayers.chin_beard}px)` }}
        >
          <svg viewBox={viewBox}>
        ...
        <div
          id="mustache_beard"
          style={{ transform: `translateZ(${zLayers.mustache_beard}px)` }}
        >
          <svg viewBox={viewBox}>
        ...
        <div
          id="eye_accents_lower"
          style={{ transform: `translateZ(${zLayers.eye_accents_lower}px)` }}
        >
          <svg viewBox={viewBox}>
            <g
              id="eye_accents_lower_g"
              class="eye_accents_g"
              transform={gTransform}
            >
              <path
        ...
        <div
          id="eye_accents_upper"
          style={{ transform: `translateZ(${zLayers.eye_accents_upper}px)` }}
        >
          <svg viewBox={viewBox}>
            <g
              id="eye_accents_upper_g"
              class="eye_accents_g"
              transform={gTransform}
            >
              <path
        ...
        <div
          id="eyebrows"
          style={{ transform: `translateZ(${zLayers.eyebrows}px)` }}
        >
          <svg viewBox={viewBox}>
        ...
        <div
          id="head_accents_upper"
          style={{ transform: `translateZ(${zLayers.head_accents_upper}px)` }}
        >
          <svg viewBox={viewBox}>
            <g
              id="head_accents_upper_g"
              class="head_accents_g"
              transform={gTransform}
            >
              <path
        ...
        <div
          id="head_accents_middle"
          style={{ transform: `translateZ(${zLayers.head_accents_middle}px)` }}
        >
          <svg viewBox={viewBox}>
            <g
              id="head_accents_middle_g"
              class="head_accents_g"
              transform={gTransform}
            >
              <path
        ...
        <div
          id="head_accents_lower"
          style={{ transform: `translateZ(${zLayers.head_accents_lower}px)` }}
        >
          <svg viewBox={viewBox}>
            <g
              id="head_accents_lower_g"
              class="head_accents_g"
              transform={gTransform}
            >
              <path
        ...
        <div
          id="nose_center"
          style={{ transform: `translateZ(${zLayers.nose_center}px)` }}
        >
          <svg viewBox={viewBox}>
            <g id="nose_center_g" transform={gTransform}>
              <path d="m 94.139323,158.10889 c 0,0 4.213411,-0.8762 6.211417,-0.32267 1.62429,0.44999 2.58267,2.33138 4.19473,2.82337 2.2632,0.69071 4.80337,0.57472 7.09877,0 2.15884,-0.54053 3.70822,-2.701 5.88875,-3.14604 1.7985,-0.36707 5.48541,0.484 5.48541,0.484" />
            </g>
          </svg>
        </div>
        ...
        <div
          id="glasses"
          style={{ transform: `translateZ(${zLayers.glasses}px)` }}
        >
          <svg viewBox={viewBox}>
